...
For this example, we use a synthetic HVAC dataset designed to emulate realistic indoor thermal behavior. You can find the dataset [here.](https://software-dl.ti.com/C2000/esd/mcu_ai/datasets/hvac_indoor_temp_forecast_dataset.zip) 
