...
The dataset can be downloaded from here: [`generic_timeseries_anomalydetection.zip`](https://software-dl.ti.com/C2000/esd/mcu_ai/datasets/generic_timeseries_anomalydetection.zip)
...
For this example, we have already prepared the dataset in the required format. You can find the zipped dataset at: [`generic_timeseries_anomalydetection.zip`](https://software-dl.ti.com/C2000/esd/mcu_ai/datasets/generic_timeseries_anomalydetection.zip)
