...
even though tinyml-tinyverse's image_classification.train.main() already
supports it."""
from unittest.mock import patch

from tinyml_modelmaker.ai_modules.vision.params import init_params
from tinyml_modelmaker.ai_modules.vision.training.tinyml_tinyverse.image_base import BaseImageModelTraining
...
def test_build_common_train_argv_includes_compile_model():
    ...
    class _Dummy(BaseImageModelTraining):
        train_module = None
        test_module = None
