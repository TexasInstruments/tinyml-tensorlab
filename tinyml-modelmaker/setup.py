...
if __name__ == '__main__':
    ...
    setup(
        ...
        url='https://bitbucket.itg.ti.com/projects/TINYML-ALGO/repos/tinyml-modelmaker',
        ...
        install_requires=[],
        project_urls={
            'Source': 'https://bitbucket.itg.ti.com/projects/TINYML-ALGO/repos/tinyml-modelmaker',
