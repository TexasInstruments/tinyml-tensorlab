...
valid_model_list = ['MotorFault_model_1_t', 'MotorFault_model_2_t', 'MotorFault_model_3_t',
                    ...
                    'TimeSeries_Generic_13k_t', 'Lenet5', 'MobileNetV1_58k_NPU', 'MobileNetV2_58k_NPU', 'PIRDetection_model_1_t', 'Pose_and_Fall_model']
...
freq_MHz_dict  = {
    ...
    constants.TARGET_DEVICE_MSPM0G3507: 80,
