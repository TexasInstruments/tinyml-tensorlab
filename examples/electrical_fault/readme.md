...
There are two dataset files present in the compressed zip: [electrical_fault_raw.zip](https://software-dl.ti.com/C2000/esd/mcu_ai/datasets/electrical_fault_raw.zip)
