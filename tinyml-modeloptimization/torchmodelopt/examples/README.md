...
|[Time series regression](./torque_time_series_regression)| [Torque Dataset](https://software-dl.ti.com/C2000/esd/mcu_ai/01_03_00/datasets/torque_measurement.csv) | Extensive Example, Dataset from TI, Generic Model, Perform QAT |
