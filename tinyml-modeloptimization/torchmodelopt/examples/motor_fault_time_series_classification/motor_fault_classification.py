...
class MotorFaultDataset(Dataset):
    ...
    The window will have a single target value which will be of the max occuring target.
    """
    ...
    def __init__(self, X, Y, window_length, window_offset, data_format='NHWC'):
        ...
        # datapoints in a single window
        self.window_length = window_length
        # offset of datapoints not to overlap in a window
...
def get_dataloader(X, Y, window_length, window_offset, batch_size):
    ...
    with length of window_lenght, offset of window_offset and batch size of dataloader.
...
def get_nn_model(in_channels, hidden_channels, feature_size, out_channels, normalize_input=True):
    ...
    class NeuralNetwork(nn.Module):
        def __init__(self):
            ...
            # linearise the last layer in given out_features
